...
describe('HeadCell', () => {
  ...
  describe('props', () => {
    ...
    describe('sortable', () => {
      test('should render sort icon if true', () => {
        const wrapper = shallow(<HeadCell sortable />);

        expect(wrapper.find(ChevronsUpDownIcon)).toHaveLength(1);
      });

      test('should not render sort icon if false', () => {
        const wrapper = shallow(<HeadCell />);

        expect(wrapper.find(ChevronsUpDownIcon)).toHaveLength(0);
      });
    });
    ...
    describe('order', () => {
      test('should render faSortUp if sortable and order="asc"', () => {
        ...
        expect(toJson(wrapper)).toMatchSnapshot();
        expect(wrapper.find(ChevronUpIcon)).toBeDefined();
      });
      ...
      test('should render faSortDown if sortable and order="desc"', () => {
        ...
        expect(toJson(wrapper)).toMatchSnapshot();
        expect(wrapper.find(ChevronDownIcon)).toBeDefined();
      });
      ...
      test('should render faSort if sortable but without order', () => {
        ...
        expect(toJson(wrapper)).toMatchSnapshot();
        expect(wrapper.find(ChevronsUpDownIcon)).toBeDefined();
      });
    });
  });
