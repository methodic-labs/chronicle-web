...
const PROPERTY_CONSTS = {
  ...
  PRIMARY_BOOK_TITLE: 'primaryBookTitle',
  PRIMARY_BOOK_TYPE: 'primaryBookType',
  PRIMARY_MEDIA_ACTIVITY: 'primaryMediaActivity',
  PRIMARY_MEDIA_AGE: 'primaryMediaAge',
  PRIMARY_MEDIA_NAME: 'primaryMediaName',
  SECONDARY_ACTIVITY: 'secondaryActivity',
  SECONDARY_BOOK_TITLE: 'secondaryBookTitle',
  SECONDARY_BOOK_TYPE: 'secondaryBookType',
  SECONDARY_MEDIA_ACTIVITY: 'secondaryMediaActivity',
  SECONDARY_MEDIA_AGE: 'secondaryMediaAge',
